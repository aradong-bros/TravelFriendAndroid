...
public class FavoriteController 
{
	...
	// 삭제 -> URL : http://222.239.250.207:8080/TravelFriendAndroid/favorite/deleteFavoriteData?user_no={user_no 값}&schedule_no={schedule_no 값}
	@RequestMapping("/deleteFavoriteData") 
	@ResponseBody
	public Map<String, Object> deleteFavoriteData(@RequestParam("user_no") int user_no,
			  									  @RequestParam("schedule_no") int schedule_no)
	{		
		Map<String, Object> map = new HashMap<String, Object>();
		
		favoriteService.deleteFavoriteData(user_no, schedule_no);
